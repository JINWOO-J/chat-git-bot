...
def main():
    ...
    parser.add_argument("--force", action="store_true", help="무시 패턴 무시")
    parser.add_argument("--no-ignore", action="store_true", help="무시 패턴 무시")
    parser.add_argument("--no-color", action="store_true", help="색상 비활성화")
    parser.add_argument("--no-progress", action="store_true", help="진행 표시 비활성화")
    parser.add_argument("--no-summary", action="store_true", help="요약 비활성화")
    parser.add_argument("--no-exit", action="store_true", help="종료 코드 비활성화")
    parser.add_argument("--no-json", action="store_true", help="JSON 형식 비활성화")
    parser.add_argument("--no-verbose", action="store_true", help="상세 출력 비활성화")
    parser.add_argument("--no-quiet", action="store_true", help="상세 출력 비활성화")
    parser.add_argument("--no-version", action="store_true", help="버전 출력 비활성화")
